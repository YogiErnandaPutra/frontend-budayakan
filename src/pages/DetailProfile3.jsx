...
import profile3 from '../images/Profile-pakar3.png'
import '../styles/DetailProfile.css'

function DetailProfile3() {
  return (
    <>
    <Navbar />
    ...
    <section id="Detail-Profile">
            <div className="kolom-chat">
                ...
                <img src={profile3} alt="Detail-Profile" className="Detail-Profile" />
                ...
                <div className="divider"></div>
                <p><Link to="/chat3" className="tbl-mulaichat">Mulai Chat</Link></p>
            </div>
            </div>
            </div>
        </section>
