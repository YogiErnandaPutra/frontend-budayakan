...
import cupang from "../images/bahan-cupang.png"
        ...
        <section className="wrap">
          <div className="kolom-tips">
            <div className="content-tips">
              <h8 className="custom-h8">Ikan Cupang</h8>
              <img src={tips8} alt="image-home1" className="tips-image" />
            </div>
          </div>
        </section>
        ...
        <section className="wrapper">
          <div className="bahan">
            ...
            <div className="bahan-container">
              ...
              <img src={cupang} alt="image-home1" className="bahan-image" />
            </div>
          </div>
        </section>
